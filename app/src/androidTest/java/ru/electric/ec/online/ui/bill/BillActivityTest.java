...
public class BillActivityTest {
    @Rule
    public ActivityTestRule<BillActivity> activityRule
            = new ActivityTestRule<BillActivity>(BillActivity.class){
        @Override
        ...
        protected Intent getActivityIntent() {
            ...
            Intent result = new Intent(targetContext, BillActivity.class);
            result.putExtra("title", "Печать счета");
            return result;
        }
    };
